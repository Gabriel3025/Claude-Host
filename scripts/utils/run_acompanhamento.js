...
async function main() {
  ...
  try {
    // Passo 1: Gerar dados com read_sheet.js e salvar em arquivo
    ...
    // Ler o arquivo e extrair JSON
    const fileContent = fs.readFileSync(tempFile, 'utf-8');
    const lines = fileContent.split('\n');

    // Encontrar onde começa e termina o JSON
    let jsonStartLine = -1;
    let jsonEndLine = -1;
    ...
    try {
      ...
      // Salvar resultados
      const resultadosPath = path.join(__dirname, 'resultados_dia7.json');
