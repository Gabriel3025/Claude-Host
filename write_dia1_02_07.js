...
// Dados coletados 02/07/2026 - DIA 1 (coluna G) via Playwright, item por item
const resultados = [
  { rowIdx: 1, produto: 'Tarot', count: 29 },
  { rowIdx: 8, produto: 'Como plantar', count: 4 },
  { rowIdx: 12, produto: 'Neuropro', count: 50 },
  { rowIdx: 20, produto: 'Airfryer', count: 29 },
  { rowIdx: 30, produto: 'Saude (Euro)', count: 70 },
  ...
  { rowIdx: 39, produto: '100 Brincadeiras Bebês', count: 6 },
  { rowIdx: 40, produto: 'Organização do Lar', count: 100 },
  ...
  { rowIdx: 44, produto: 'JiuJistsu (LATAM)', count: 4 },
  { rowIdx: 52, produto: 'Atividades Copa do mundo', count: 0 },
  { rowIdx: 53, produto: 'Calistenia asiática', count: 87 },
  ...
  { rowIdx: 64, produto: 'Calistenia asiática 2', count: 87 },
  { rowIdx: 65, produto: 'Atividades de português', count: 62 },
  { rowIdx: 66, produto: 'Atividades em segundos', count: 9 },
  { rowIdx: 67, produto: 'Figurinhaa do filho', count: 12 },
  { rowIdx: 68, produto: 'Potinho da fé', count: 18 },
  ...
  { rowIdx: 87, produto: 'Exercícios para TDAH', count: 0 },
  { rowIdx: 88, produto: 'Molde Roupa PET', count: 18 },
  { rowIdx: 89, produto: 'Cristão + Hidroponica', count: 32 },
  { rowIdx: 90, produto: 'TCC com IA (R$ 297,00)', count: 65 },
  { rowIdx: 91, produto: 'Catalogo Estética automotiva', count: 17 },
  { rowIdx: 92, produto: 'Atividades para idosos', count: 13 },
  { rowIdx: 93, produto: 'Atividades para copa', count: 0 },
  { rowIdx: 94, produto: 'Adesivo Sono', count: 71 },
  { rowIdx: 95, produto: 'Simulado CNH', count: 18 },
  { rowIdx: 96, produto: 'Matemática Minecraft', count: 9 },
  ...
  { rowIdx: 100, produto: 'Dor na coluna (Acompanhar)', count: 18 },
  { rowIdx: 101, produto: '150 Bonecas de Papel', count: 27 },
];
...
async function main() {
  try {
    ...
    console.log(`✅ Acompanhamento Ofertas DIA 1 (02/07/2026): ${acompanhamentoData.length} células gravadas`);
