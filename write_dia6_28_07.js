...
const resultados = JSON.parse(fs.readFileSync(process.argv[2], 'utf8')).resultados;
...
async function main() {
  try {
    ...
    console.log(`✅ Acompanhamento Ofertas DIA 6 (28/07/2026): ${acompanhamentoData.length} células gravadas`);
