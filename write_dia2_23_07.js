...
const resultados = JSON.parse(fs.readFileSync('scratch_resultados_dia2_23_07.json', 'utf8'));
...
async function main() {
  try {
    ...
    console.log(`✅ Acompanhamento Ofertas DIA 2 (23/07/2026): ${acompanhamentoData.length} células gravadas`);
