...
export const EXERCISES_DATA: Day[] = [
  // DIA 1 - 10 minutos
  {
    ...
    exercises: [
      {
        id: "1-1",
        name: "Aquecimento - Arm Circles",
        duration: 2,
        gif: "https://media.giphy.com/media/lqG23YjZr2p6U/giphy.gif",
        description: "Movimentos circulares com os braços para aquecer",
      },
      {
        id: "1-2",
        name: "Push-ups (10 repetições)",
        duration: 4,
        gif: "https://media.giphy.com/media/J0KWz8UNH51pNhHc1I/giphy.gif",
        description: "Flexões clássicas. Mantenha o corpo alinhado.",
      },
      {
        id: "1-3",
        name: "Squats (15 repetições)",
        duration: 4,
        gif: "https://media.giphy.com/media/qrNZlhSC0yMw8/giphy.gif",
        description: "Agachamentos com peso no corpo. Joelhos atrás dos pés.",
      },
    ],
  },
