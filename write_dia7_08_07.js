...
const resultados = JSON.parse(fs.readFileSync('scratch_resultados_dia7.json', 'utf8'));
...
async function main() {
  try {
    ...
    console.log(`✅ Acompanhamento Ofertas DIA 7 (08/07/2026): ${acompanhamentoData.length} células gravadas`);
