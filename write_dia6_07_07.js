...
const resultados = JSON.parse(fs.readFileSync('scratch_resultados_dia6.json', 'utf8'));
...
async function main() {
  try {
    ...
    console.log(`✅ Acompanhamento Ofertas DIA 6 (07/07/2026): ${acompanhamentoData.length} células gravadas`);
